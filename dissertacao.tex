...
\begin{center}
    ...
    \vskip 0.5cm
    \normalsize{Rio de Janeiro, junho de 2014}
\end{center}
...
e mitigação de perdas, envolve fundamentalmente a análise de ameaça sísmica, ou o nível de 
determinada medida de intensidade em certo local, no qual, durante um certo tempo, a chance de que 
essa intensidade seja excedida seja de um certo percentil de probabilidade.
...
e a pouca quantidade de informação são fonte de muitas incertezas e dificuldade de análise pelos métodos mais clássicos
e conhecidos que geralmente consideram, através de opiniões de especialistas, determinadas zonas sísmicas.

Esse texto discute algumas técnicas de suavização e seus fundamentos como métodos alternativos ao zoneamento,
...
It involves, mainly, the evaluation of seismic hazard, or in other words, the level of some intensity ground motion
measure, in a given site, which, in some time window, will be exceeded in some probability percentile.
...
methods for seismicity characterization. Next, the methods are exemplified in the brasilian context.
...
\input{c01-introducao}        % associado ao arquivo: 'cap-introducao.tex'
\input{c02-conceitos}         % associado ao arquivo: 'cap-conceitos.tex'
\input{c03-regiao}        	  % associado ao arquivo: 'cap-conclusoes.tex'
\input{c04-metodologia}       % associado ao arquivo: 'cap-introducao.tex'
\input{c05-processamento}     % associado ao arquivo: 'cap-conceitos.tex'
\input{c06-resultados}        % associado ao arquivo: 'cap-conclusoes.tex'
\input{c07-conclusoes}        % associado ao arquivo: 'cap-conclusoes.tex'
