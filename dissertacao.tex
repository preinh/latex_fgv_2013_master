...
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Análise Probabilística de Rísco Sísmico (PSHA) \\
    não-paramétrica de longo prazo para o Brasil}}\\
...
Ao Grupo de Sismologia do Instituto de Astronomia Geofísica e Ciências
Atmosféricas (IAG) da Universidade de São Paulo (USP) por todo apoio e suporte
durante os anos em que estive dividido entre o curso de mestrado e o trabalho.
...
\noindent PIRCHINER, M. \textbf{Análise Probabilística de Rísco Sísmico (PSHA) \\
	    não-paramétrica de longo prazo para o Brasil}. 
2014. 120 f.
...
\input c03-conclusoes        % associado ao arquivo: 'cap-conclusoes.tex'
